###Submission
Please click on the Link under "Enviroments" to access the application deployed with Heroku. All Operations are funtional minus a few bugs here and there. **Refreshing the page will give you a 404, If that happens return back to root URL and log back in, all data is persisted in database** 
