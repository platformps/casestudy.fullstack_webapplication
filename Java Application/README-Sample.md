...
* Ensure that the `start-class` tag in your `pom.xml` encapsulates `com.github.Jcruz9.MyApplication`
...
#### Part 3 - Cloning _forked_ com.github.Jcruz9.repository
* Clone the com.github.Jcruz9.repository from **your account** into the `~/dev` directory.
...
#### Part 1 -  _Pushing_ local changes to remote com.github.Jcruz9.repository
...
* from the root directory of the project, execute the following commands:
    ...
    * push changes to your com.github.Jcruz9.repository
