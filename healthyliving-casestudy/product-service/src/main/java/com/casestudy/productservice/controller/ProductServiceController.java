...
import com.casestudy.productservice.serviceLayer.ProductService;
...
public class ProductServiceController {
    ...
    public void updateProduct(@RequestBody @Valid Product product,@PathVariable int id)  {
        ...
        if (id!=product.getProductId()){
            throw new com.casestudy.productservice.exception.NotFoundException("path id should match with id: "+id);
        } else {
